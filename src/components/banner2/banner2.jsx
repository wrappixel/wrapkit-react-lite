                ...
                <div className="container">
                    <div className="row justify-content-center">
                        <div class="col-lg-8 col-md-6 align-self-center text-center" data-aos="fade-up" data-aos-duration="1200">
                            ...
                            <a href="https://wrappixel.com/templates/wrapkit-lite/" className="btn btn-outline-light m-r-20 btn-md m-t-30 font-14">Download Free</a>
                            <a href="https://wrappixel.com/templates/wrapkit/" className="btn btn-md m-t-30 btn-danger-gradiant font-14">Upgrade To Pro</a>
                        </div>
                    </div>
                </div>
            </div>
